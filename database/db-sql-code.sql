...
CREATE TABLE public.master_key (
	master_key_id INT GENERATED BY DEFAULT AS IDENTITY,
	account_type CHARACTER VARYING NOT NULL,
	master_key_hash character varying NOT NULL,
	CONSTRAINT master_key_pk PRIMARY KEY (master_key_id)
);